...
ClubGorman_Nutrients_Wide <- subset(Ellerbe_Nutrients_Wide, site_no == "0208675010" | site_no == "02086849" | site_no == "J1330000")
...
ClubGorman_Nutrients_Long <- subset(Ellerbe_Nutrients_Long, site_no == "0208675010" | site_no == "02086849" | site_no == "J1330000")

write.csv(ClubGorman_Nutrients_Long, row.names = FALSE, 
          file = "./Data/Processed/CClubGorman_Nutrients_Long_Processed.csv")
```
