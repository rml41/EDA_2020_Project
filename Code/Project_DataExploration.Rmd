...
NPplot <-
  ggplot(Club.Gorman_Flow.NP_Long, aes(x= CharacteristicName, y = ResultMeasureValue, fill = Location)) +
  geom_boxplot()
print(NPplot)

Flowplot <-
  ggplot(Club.Gorman_Flow.Nutrients_Long, aes(x= "", y = Discharge, fill = Location, color = Location)) +
  geom_boxplot()
print(Flowplot)
