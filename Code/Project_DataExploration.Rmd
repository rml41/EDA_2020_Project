...
Club.Gorman_Flow.NP_Long$CharacteristicName <- gsub("Nitrogen, mixed forms (NH3), (NH4), organic, (NO2) and (NO3)", "TN", Club.Gorman_Flow.NP_Long$CharacteristicName)
...
NPplot <-
  ...
  geom_boxplot()+
  labs(title = "Nutrient Concentrations and Flow at Upstream and Downstream Locations along Ellerbe Creek", x = "Nutrient", y = "Concentration (mg/L)", color = "")+
...
Flowplot <-
  ...
  labs(x = "", y = (expression(paste("Discharge"  (ft^3/s)))), color = "", caption = "Figure 1. Boxplot of nitrogen and phosphorus concentrations at monitoring sites upsteam (near Club Blvd in Durham, NC) \nand downstream (near Falls Lake in Gorman, NC) in comparison to boxplot of upstream and downstream flow of Ellerbe Creek in North Carolina.")+
